...
public class BoardController {
	...
	public void listPage(Criteria cri, Model model, BoardVo boardVo) throws Exception {
		model.addAttribute("cri", boardService.listCri(cri));
	...
	public void writeView(BoardVo boardVo, @ModelAttribute("cri") Criteria cri, Model model) throws Exception {
	}

	// 게시글 작성
	@RequestMapping(value = "/write", method = RequestMethod.POST)
	public String write(BoardVo boardVo, @ModelAttribute("cri") Criteria cri, RedirectAttributes rttr)
			throws Exception {
	...
	public void read(@RequestParam("bno") int bno, @ModelAttribute("cri") Criteria cri, ReplyVo replyVo, Model model)
			throws Exception {
	...
	public void modifyView(@RequestParam("bno") int bno, @ModelAttribute("cri") Criteria cri, Model model)
			throws Exception {
